...
if __name__ == "__main__":
    ...
    chrome_driver_path = r'/home/tim/Development/IR/final_project/scrapers/Drivers/chromedriver.exe'
    service = Service(ChromeDriverManager().install()) # Can replace with executable_path=chrome_driver_path
